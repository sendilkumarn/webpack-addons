...
const createCommonsChunkPlugin = require('../../index').createCommonsChunkPlugin;

const Input = require('../../index').Input;
const Confirm = require('../../index').Confirm;
const RawList = require('../../index').RawList;
