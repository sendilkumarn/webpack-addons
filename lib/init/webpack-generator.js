...
const createCommonsChunkPlugin = require('../../index.js').createCommonsChunkPlugin;

const Input = require('../../index.js').Input;
const Confirm = require('../../index.js').Confirm;
console.log(Confirm)
const RawList = require('../../index.js').RawList;
